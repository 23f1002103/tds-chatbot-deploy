...
def crawl_page(page, url):
    ...
    try:
        ...
        print(f"❌ Error loading page: {url} - {e}") # Improved error message
        return
    ...
    with open(filepath, "w", encoding="utf-8") as f:
        f.write("---\n") # Added newline for proper YAML frontmatter
        f.write(f'title: "{title}"\n') # Corrected line with single quotes for f-string, added newline
        f.write(f'original_url: "{url}"\n') # Corrected line, added newline
